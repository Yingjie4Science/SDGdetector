...
test_that("Detect indirect mentions of SDGs and associated targets", {
  ...
  expect_equal(findSDGs(df1, col)$match_detail, 'SDG1_general, SDG1_1, SDG1_2, ')
  expect_equal(findSDGs(df2, col)$match_detail, 'SDG2_1, ')
  expect_equal(findSDGs(df3, col)$match_detail, 'SDG1_1, SDG1_2, ')
})
